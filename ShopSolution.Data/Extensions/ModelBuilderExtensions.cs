...
namespace ShopBankSolution.Data.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
           ...
           new Product()
           {
            ...
            // any guid
            var roleId = new Guid("B958536F-D146-4B77-9CD5-32E39FE3819B");
            var adminId = new Guid("8D3DECDE-C828-4E4A-B338-9B5DAD31255F");
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                Email = "lacvaogiacmo.9x@gmail.com",
                NormalizedEmail = "lacvaogiacmo.9x@gmail.com",
                EmailConfirmed = true,
